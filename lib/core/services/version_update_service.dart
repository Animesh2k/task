...
class VersionUpdateService {
  ...
  // Get package identifiers from Firebase options
  static String get _androidPackageName =>
      'com.example.weavers_flutter_base_project'; // Update with your actual package name
  static String get _iosBundleId =>
      DefaultFirebaseOptions.ios.iosBundleId ??
      'com.example.weaversFlutterBaseProject';
